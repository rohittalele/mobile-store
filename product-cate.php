...
<head>
	...
	<title>Mobile Shop | Product Category</title>
    <style type="text/css">
  .wish{
...
?>
  ...
  <div class="card-body">
    ...
    <a href="./scripts/direct-addtocart-script.php?id=<?php echo $p_res['id']; ?>" class="btn btn-dark <?php if($cr){ echo "disabled"; } ?>"><i class="fa fa-shopping-cart"></i></a>
  </div>
</div>
<?php } ?>
