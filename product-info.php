...
<head>
	...
	<title>Mobile Shop | Product Information</title>
...
<dl class="item-property">
  ...
  <a href="./scripts/direct-addtocart-script.php?id=<?php echo $p_res['id']; ?>" class="btn btn-dark <?php if($cr){ echo "disabled"; } ?>"><i class="fa fa-shopping-cart"></i> <?php if($cr){ echo "Added to Cart"; }else{ echo "Add to Cart"; } ?> </a>
  </div>
